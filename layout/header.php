<?php
// có thể gọi từ model bất kỳ lên phần header nhưng ảnh hưởng đến các trang còn lại
$sql = "SELECT SUM(number_cart) as 'num_cart' FROM tbl_cart";
$sql1 = "SELECT * FROM tbl_cart";
$data = db_fetch_row($sql);
$num = db_num_rows($sql1);
...
<head>
    ...
    <link href="public/css/font-awesome/css/sweetalert2.min.css" rel="stylesheet" type="text/css" />
    <link href="public/css/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
    <link href="public/style.css" rel="stylesheet" type="text/css" />
    <link href="public/responsive.css" rel="stylesheet" type="text/css" />
    <script src="public/js/jquery-3.6.1.min.js" type=""></script>
    <script src="public/js/jquery-2.2.4.min.js" type="text/javascript"></script>
    <script src="public/js/app.js" type=""></script>
    <script src="public/js/sweetalert2.min.js" type=""></script>
                        ...
                        <div id="action-wp" class="fl-right">
                            ...
                            <div id="cart-wp" class="fl-right">
                                <div id="btn-cart">
                                    <i class="fa fa-shopping-cart" aria-hidden="true"></i>
                                    <?php if ($num > 0) { ?>
                                        <span id="num" class="num-order"><?php if ($num > 0) {
                                                                                echo $data['num_cart'];
                                                                            }
                                ...
                                <?php if ($num > 0) { ?>
                                    <div id="dropdown">
                                        <p class="desc">Có <span> <?php echo $data['num_cart']; ?> sản phẩm</span> trong giỏ hàng</p>
                                        <ul class="list-cart">
                                            ...
                                            ?>
                                                    <li class="clearfix">
                                                        ...
                                                        <div class="info fl-right">
                                                            ...
                                                            <p class="price"><?php echo format_number($item['price']); ?></p>
                                                            <p class="qty">Số lượng: <span><?php echo $item['number_cart']; ?></span></p>
                                                        </div>
                                                    </li>
                                            <?php }
                                            } ?>
                                        ...
                                        <div class="total-price clearfix">
                                            ...
                                            <p class="price fl-right"><?php echo format_number($total_cart['tongtien']);  ?></p>
                                        </div>
