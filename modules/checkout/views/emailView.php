    ...
    <table width="100%" border ="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
        <tbody>
            ...
            <tr>
                ...
                <td width="20%" align="left" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;color:#666666;padding:0 10px 10px 10px" colspan="2">#5522</td>
            </tr>
            <tr>
            ...
            <tr>
                <td bgcolor="#f6f6f6" width="40%" align="left" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;padding:10px 10px 10px 10px"><a>Html Css 21 Ngày - Thành thạo xây dựng giao diện web thực tế từ bản thiết kế Photoshop</a>
                </td>
