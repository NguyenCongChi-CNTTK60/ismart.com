                ...
                <div class="section-detail">
                    <ul class="list-item">
                        <li>
                            ...
                            <a href="?mod=product&action=index" title="" class="product-name">Laptop Lenovo IdeaPad 120S</a>
                            <div class="price">
                ...
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        ...
                        <li>
                            ...
                            <a href="?mod=product&action=detail" title="" class="product-name">Xiaomi Mi A1</a>
                            <div class="price">
                                <span class="new">5.990.000đ</span>
                                <span class="old">6.990.000đ</span>
                            </div>
